...
namespace http_server {
        ...
        using HttpHandler = int (*)(struct netconn *conn, [[maybe_unused]] std::string_view request);
        ...
        class HttpServer {
            ...
            private:
                ...
                static bool parse_request_line(const char *req, size_t len, HttpMethod &method, std::string_view &uri);
